...
class Runtime:
    ...
    def health(self): return {"healthy": self.state != "stopped", "reason": self.reason}
    ...
    def diagnostic_snapshot(self): return {"module": "analyzer", "state": self.state, "reason": self.reason}
